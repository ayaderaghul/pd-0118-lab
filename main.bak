...
(define (gen-name id name)
  (format "/Users/linhchi.nguyen/Dropbox/pd-0118/~a~a" (number->string id) name))
...
(define (main)
  (collect-garbage)
  (define POPU (format "/Users/linhchi.nguyen/Dropbox/pd-0118/~ap.txt" SIM-ID))
  (define p-POPU (format "/Users/linhchi.nguyen/Dropbox/pd-0118/~ap.txt" (- SIM-ID 1)))
  (define POPULATION
    (if (= SIM-ID 1)
